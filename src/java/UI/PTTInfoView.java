 ...
 * @author MA-Aunchalee
 */
public class PTTInfoView extends javax.swing.JFrame {

    /**
     * Creates new form PTTInfoView
     */
    public PTTInfoView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jBGetResult.setText("get result");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PTTInfoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PTTInfoView().setVisible(true);
            }
        });
    }
